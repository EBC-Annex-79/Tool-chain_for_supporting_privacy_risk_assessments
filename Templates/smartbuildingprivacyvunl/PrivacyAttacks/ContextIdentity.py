...
class ContextLocationToFloorIdentity (IPrivacyAttack):
    ...
    def _build_model(self):
        ...
        self.graph.add((contextLocationToRoomIdentity, self.PRIVVULN.creates, contextIdentity))
        self.graph.add((contextIdentity, self.PRIVVULNV2.privacyRiskScore, Literal("1", datatype=self.XSD.int)))
        self.graph.add((contextIdentity, self.PRIVVULNV2.privacyStrategy, Literal("Consider using this pattern", datatype=self.XSD.string)))
        self.graph.add((contextIdentity, self.PRIVVULNV2.privacyStrategy, Literal("Consider using this pattern 2", datatype=self.XSD.string)))
...
class ContextLocationOccupantCountAndScheduleActivitiesToTeachingPerformance (IPrivacyAttack):
    ...
    def _build_model(self):
        ...
        # self.graph.add((teachingPerformance, self.PRIVVULNV2.privacyStrategy, Literal("Consider using this pattern 2", datatype=self.XSD.string)))
