...
g1.add((humidity, PRIVVULNV2.TemporalResolution, Literal("60", datatype=XSD.double)))
g1.add((floor3_room1, PRIVVULNV2.has, humidity))

illuminance = M['IlluminanceStream']
g1.add((illuminance, RDF.type, SBUILDING.Illuminance))
g1.add((illuminance, RDF.type, PRIVVULN.TimeSeries))
g1.add((illuminance, PRIVVULNV2.TemporalResolution, Literal("60", datatype=XSD.double)))
g1.add((floor3_room1, PRIVVULNV2.has, illuminance))
...
g1.add((temperature, PRIVVULNV2.TemporalResolution, Literal("60", datatype=XSD.double)))
g1.add((floor3_room1, PRIVVULNV2.has, temperature))
...
scheduleActivities1 = M['ScheduleActivities1']
g1.add((scheduleActivities1, RDF.type, SBUILDING.ScheduleActivities))
g1.add((scheduleActivities1, RDF.type, PRIVVULN.External))
g1.add((floor2_room2, PRIVVULNV2.has, scheduleActivities1))

humidity1 = M['HumidityStream1']
g1.add((humidity1, RDF.type, SBUILDING.Humidity))
g1.add((humidity1, RDF.type, PRIVVULN.TimeSeries))
g1.add((humidity1, PRIVVULNV2.TemporalResolution, Literal("60", datatype=XSD.double)))
g1.add((floor2_room2, PRIVVULNV2.has, humidity1))

illuminance1 = M['IlluminanceStream1']
g1.add((illuminance1, RDF.type, SBUILDING.Illuminance))
g1.add((illuminance1, RDF.type, PRIVVULN.TimeSeries))
g1.add((illuminance1, PRIVVULNV2.TemporalResolution, Literal("60", datatype=XSD.double)))
g1.add((floor2_room2, PRIVVULNV2.has, illuminance1))
...
g1.add((floor2_room2, PRIVVULNV2.has, roomCountingLinesStream1))

temperature1 = M['TemperatureStream1']
g1.add((temperature1, RDF.type, SBUILDING.Temperature))
g1.add((temperature1, RDF.type, PRIVVULN.TimeSeries))
g1.add((temperature1, PRIVVULNV2.TemporalResolution, Literal("60", datatype=XSD.double)))
g1.add((floor2_room2, PRIVVULNV2.has, temperature1))
...
g1.add((floor2_room2, PRIVVULNV2.has, vAVStream1))
...
g1.add((floor2_room2, PRIVVULNV2.has, cO2Steam1))

floor2_room3 = M['StudyZone_Room2']
g1.add((floor2_room3, RDF.type, SBUILDING.Studyzone_Room))

humidity2 = M['HumidityStream2']
g1.add((humidity2, RDF.type, SBUILDING.Humidity))
g1.add((humidity2, RDF.type, PRIVVULN.TimeSeries))
g1.add((humidity2, PRIVVULNV2.TemporalResolution, Literal("60", datatype=XSD.double)))
g1.add((floor2_room3, PRIVVULNV2.has, humidity2))

illuminance2 = M['IlluminanceStream2']
g1.add((illuminance2, RDF.type, SBUILDING.Illuminance))
g1.add((illuminance2, RDF.type, PRIVVULN.TimeSeries))
g1.add((illuminance2, PRIVVULNV2.TemporalResolution, Literal("60", datatype=XSD.double)))
g1.add((floor2_room3, PRIVVULNV2.has, illuminance2))
...
g1.add((floor2_room3, PRIVVULNV2.has, roomCountingLinesStream2))

temperature2 = M['TemperatureStream2']
g1.add((temperature2, RDF.type, SBUILDING.Temperature))
g1.add((temperature2, RDF.type, PRIVVULN.TimeSeries))
g1.add((temperature2, PRIVVULNV2.TemporalResolution, Literal("60", datatype=XSD.double)))
g1.add((floor2_room3, PRIVVULNV2.has, temperature2))
...
g1.add((floor2_room3, PRIVVULNV2.has, vAVStream2))
...
g1.add((floor2_room3, PRIVVULNV2.has, cO2Steam2))
