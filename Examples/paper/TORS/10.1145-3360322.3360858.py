...
heartRateOcc = M['HeartRate_Occ']
g1.add((heartRateOcc, RDF.type, SBUILDING.HeartRate))
g1.add((heartRateOcc, RDF.type, PRIVVULN.TimeSeries))
g1.add((heartRateOcc, PRIVVULNV2.TemporalResolution, Literal("60.0", datatype=XSD.double)))
g1.add((occ, PRIVVULNV2.has, heartRateOcc))

galvanicSkinResponseFeedbackOcc = M['galvanicSkinResponseFeedback_Occ']
g1.add((galvanicSkinResponseFeedbackOcc, RDF.type, SBUILDING.GalvanicSkinResponseFeedback))
g1.add((galvanicSkinResponseFeedbackOcc, RDF.type, PRIVVULN.TimeSeries))
g1.add((galvanicSkinResponseFeedbackOcc, PRIVVULNV2.TemporalResolution, Literal("60.0", datatype=XSD.double)))
g1.add((occ, PRIVVULNV2.has, galvanicSkinResponseFeedbackOcc))
