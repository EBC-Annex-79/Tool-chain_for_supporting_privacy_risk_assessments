...
g1.add((outside, PRIVVULN.star, building))
...
g1.add((room, PRIVVULN.star, building))

contextLocation2 = M['ContextLocation2']
g1.add((contextLocation2, RDF.type, SBUILDING.ContextLocation))
g1.add((contextLocation2, RDF.type, PRIVVULN.Metadata))
g1.add((room, PRIVVULNV2.has, contextLocation2))
...
g1.add((building, PRIVVULN.star, conference))

contextLocation3 = M['ContextLocation3']
g1.add((contextLocation3, RDF.type, SBUILDING.ContextLocation))
g1.add((contextLocation3, RDF.type, PRIVVULN.Metadata))
g1.add((conference, PRIVVULNV2.has, contextLocation3))
